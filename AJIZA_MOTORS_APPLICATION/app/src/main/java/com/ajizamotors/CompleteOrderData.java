...
public class CompleteOrderData {
    ...
    public CompleteOrderData(String name, String carModel, String address, String payment, String price, String sellerName, String sellerContact, String imageUrl, String ajizaComition, String orderCount) {
        this.name = name;
        CarModel = carModel;
